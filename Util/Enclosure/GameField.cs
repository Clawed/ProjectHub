...
using ProjectHub.Util.Enclosure.Algorithm;

namespace ProjectHub.Util.Enclosure
{
    public class GameField : IPathNode
    {
        ...
        public List<PointField> doUpdate()
        {
            ...
            while (_newEntries.Count > 0)
            {
                ...
                currentField[currentlyChecking.X, currentlyChecking.X] = currentlyChecking.Value;
